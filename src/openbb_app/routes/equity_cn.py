...
def get_historical_data(
    ...
    try:
        ...
        try:
            data, source = data_source_manager.get_data(symbol, start_date, end_date, interval)
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch data from all sources")
